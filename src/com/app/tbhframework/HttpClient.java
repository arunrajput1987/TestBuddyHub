...
public class HttpClient {
    ...
    static {
        String proxyIP = System.getProperty("http.proxy.host");
        String proxyPort = System.getProperty("http.proxy.port");
        boolean isProxySecure = StringUtils.isNotBlank(System.getProperty("http.is.proxy.secure")) ? Boolean.valueOf(System.getProperty("http.is.proxy.secure")) : false;
    ...
    private static CredentialsProvider getHttpProxyCredentials() {
        boolean authEnabled = StringUtils.isNotBlank(System.getProperty("http.proxy.auth.enabled"))
                ? Boolean.valueOf(System.getProperty("http.proxy.auth.enabled")) : false;
        if (authEnabled) {
            CredentialsProvider credsProvider = new BasicCredentialsProvider();
            credsProvider.setCredentials(
                    AuthScope.ANY,
                    new UsernamePasswordCredentials(System.getProperty("http.proxy.auth.name"), System.getProperty("http.proxy.auth.password")));
