...
public class TBHBaseUtil {
	...
	public TBHBaseUtil(WebDriver driver, String driverType, HashMapNew Dictionary, HashMapNew Environment, Reporting Reporter, Assert Assert, SoftAssert SoftAssert){
		this.driver = driver;
	...
	/**
     * Set an attribute in the HTML of a page at run time.
     *
    ...
    public void setAttribute(WebElement element, String attributeName,String attributeValue) {
    	...
    	String is = String.format("arguments[0].value='%s';",attributeValue);
    	if(js != null){
        js.executeScript(is, element);
        	Reporter.log("Verify attribute  " + attributeName + " is set", attributeValue + " should be ", attributeValue + "  is set successfully", "Pass");
    	}else{
    		Reporter.log("Verify attribute  " + attributeName + " is set", attributeValue + " should be ", attributeValue + "  is not set successfully", "Fail");
    	}
//    	String is = String.format("arguments[0].setAttribute=('%s','%s');",attributeName,attributeValue);
//        js.executeScript(is, element);
        try {
			Thread.sleep(6000);
